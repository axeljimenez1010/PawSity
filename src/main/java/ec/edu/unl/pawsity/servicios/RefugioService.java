...
public class RefugioService {
    ...
    @PostConstruct
    public void init() {
        this.refugio = new Refugio("PawSity Central", 30);
        this.sistemaDeSolicitudes = new ArrayList<>();
        this.baseDeDatosUsuarios = new ArrayList<>();


        baseDeDatosUsuarios.add(new Administrador("admin@pawsity.ec", "Admin123", "Laura", "", "Rescue Admin"));
        baseDeDatosUsuarios.add(new Veterinario("veterinario@pawsity.ec", "Vet123", "Mario", "", "Cirujano", "LIC-01"));
        baseDeDatosUsuarios.add(new Adoptante("adoptante@pawsity.ec", "Adopta123", "Carlos", "", "099", "Centro", "Docente"));
